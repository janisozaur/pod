...
DctBandPassFilter::DctBandPassFilter(QObject *parent) :
	TransformFilter(parent)
{
}

QString DctBandPassFilter::name() const
{
	return "DCT band pass";
}

bool DctBandPassFilter::setup(const FilterData &data)
{
...
DisplayWindow *DctBandPassFilter::apply(QString windowBaseName)
{
