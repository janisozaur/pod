...
DctBandStopFilter::DctBandStopFilter(QObject *parent) :
	TransformFilter(parent)
{
}

QString DctBandStopFilter::name() const
{
	return "DCT band stop";
}

bool DctBandStopFilter::setup(const FilterData &data)
{
