...
DctLowPassFilter::DctLowPassFilter(QObject *parent) :
	TransformFilter(parent)
{
}

QString DctLowPassFilter::name() const
{
	return "DCT low pass";
}

bool DctLowPassFilter::setup(const FilterData &data)
{
...
DisplayWindow *DctLowPassFilter::apply(QString windowBaseName)
{
